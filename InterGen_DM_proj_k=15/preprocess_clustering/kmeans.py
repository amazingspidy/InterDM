...
# np.save("train_500_embeddings_pca_kmeans_n=15.npy", save_data)

# print(f"KMeans로 1 클러스터링 완료! 'train_500_embeddings_pca_clustered.npy'로 저장했어.")


import numpy as np

# KMeans 결과에서 가져온 데이터 (예시)
data = np.load("preprocess_clustering/train_500_embeddings_pca_kmeans_n=15.npy", allow_pickle=True).item()
...
# 3. 딕셔너리 저장
np.save("train_500_index_to_cluster_n=15.npy", index_to_cluster)
